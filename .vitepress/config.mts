      ...
      '/tiny-engine/engines/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: '使用状态管理和变量绑定',
              link: 'state-management-and-variable-binding',
            },
            {
              text: '行内样式绑定状态变量',
              link: 'inline-style-variable-binding',
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: '使用JS面板和事件绑定',
              link: 'js-panel-and-event-binding',
            },
            ...
            {
              text: '集成ChatGPT搭建简单页面能力',
              link: 'integrating-chatgpt-for-simple-pages',
            },
            { text: '新版AI插件使用', link: 'new-ai-plugin-usage' },
            {
              text: '数据源和Collection—远程字段',
              link: 'data-source-and-collection-remote-fields',
            },
            {
              text: '数据源和Collection—mock数据',
              link: 'data-source-and-collection-mock-data',
            },
            {
              text: '数据源和Collection—使用数据源',
              link: 'data-source-and-collection-usage',
            },
            {
              text: '路由功能',
              collapsed: false,
              ...
              items: [
                ...
                {
                  text: '路由bar一键清除预览页面路径',
                  link: 'route-bar-clear-preview-page',
                },
                {
                  text: '路由bar高亮显示预览页面路径',
                  link: 'route-bar-current-page-highlight',
                },
                {
                  text: 'RouterView支持预览子界面',
                  link: 'route-view-support-preview-subpage',
                },
              ],
            },
      ...
      '/tiny-engine/dev/': [
        {
          ...
          items: [
            ...
            {
              text: '前后端启动联调(Java服务端)',
              link: 'debugging-of-java-backend',
            },
          ],
        },
        {
          ...
          items: [
            { text: '如何开发插件', link: 'how-to-develop-plugins' },
            {
              ...
              items: [
                {
                  text: '出码功能简介与使用',
                  link: 'code-output-overview-and-usage',
                },
                {
                  text: '如何自定义出码',
                  link: 'how-to-customize-code-output',
                },
                {
                  text: '如何自定义出码插件',
                  link: 'how-to-customize-code-output-plugins',
                },
                {
                  text: '自定义页面出码插件',
                  link: 'custom-page-code-output-plugin',
                },
        ...
        },
        {
          ...
          items: [
            {
              text: 'PDM元数据审批电子流',
              link: 'pdm-metadata-approval-workflow',
            },
            {
              text: '图元编排设计器',
              link: 'graphical-element-arrangement-designer',
            },
            {
              text: 'SMB轻量应用服务',
              link: 'smb-lightweight-application-service',
            },
          ],
        },
      ],
